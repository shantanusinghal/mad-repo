 ...
 *
 */
public class HandCodedPlayer_singhal5 extends NannonPlayer {

	/**
	 * You should rename this file to:  HandCodedPlayer_yourLoginName.java
	 *
	 */
	public HandCodedPlayer_singhal5() {
	}

	public HandCodedPlayer_singhal5(NannonGameBoard gameBoard) {
		super(gameBoard);
	}
	@Override
	public String getPlayerName() {
		...
		return "Shantanu's Hand-Coded Player";
	}
