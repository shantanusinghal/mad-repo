...
// 	 "\n" +
	...
	public static void main(String[] argsRaw) {
		...
		Nannon.setPrintProgress(true); // Set to 'true' to watch the games being played.  ***** >>>>> Set to 'false' when doing long runs. <<<<< *****
		...
		String   arg1 = "FullJointProbTablePlayer_singhal5"; // See argsSpecString for other options.
		String   arg2 = "random";
		...
		int numberPostBurninGamesToPlay =    10;
...
//		Nannon.setNumberOfGamesInBurnInPhase( 100 * 1000); // This (i.e. 100k) is a good number for experiments, but when debugging might want to set this to 0.
		...
		NannonGUI.setAnimationSpeed(0);      // Set this to 1-100 to vary speed of animation; 50 seems a good value, but will be machine-dependent (if 0 or less, than no waiting, ie drawing is as fast as possible).
